...
Unter der Haube nutzt 5chan die API-Schicht plebbit-js für seine Protokollinteraktionen. Wie in der Warnung oben erwähnt, tragen diese internen Referenzen immer noch alte Namen, die vor der Umbenennung von Bitsocial entstanden sind.
