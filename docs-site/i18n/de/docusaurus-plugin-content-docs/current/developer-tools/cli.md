...
Es basiert auf `plebbit-js` und wird von [5chan](/apps/5chan/) und [Seedit](/apps/seedit/) für die Community-Erstellung und Knotenverwaltung verwendet.
...
| `subplebbit stop`   | Hören Sie auf, einer bestimmten Community zu dienen                 |

Führen Sie einen beliebigen Befehl mit `--help` aus, um die verfügbaren Optionen und Flags anzuzeigen:
