...
Поскольку пакет представляет собой чистый генератор изображений, он не занимается управлением сетью или сеансами самостоятельно. Он предназначен для интеграции в более крупный поток запросов — например, как один из типов запросов, поддерживаемых [Блокировщик спама](./spam-blocker.md).
