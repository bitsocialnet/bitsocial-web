...
Крючки организованы по функциональным категориям. Ниже приводится краткое описание наиболее часто используемых крючков в каждой категории. Полные подписи, параметры и типы возвращаемых значений см. в [полной ссылке на API на GitHub](https://github.com/bitsocialnet/bitsocial-react-hooks).
...
- **GitHub:** [bitsocialnet/bitsocial-реагировать-крючки](https://github.com/bitsocialnet/bitsocial-react-hooks)
