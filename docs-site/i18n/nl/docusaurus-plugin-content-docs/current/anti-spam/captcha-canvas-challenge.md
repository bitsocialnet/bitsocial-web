...
Omdat het pakket een pure afbeeldingsgenerator is, wordt er geen netwerk- of sessiebeheer op zijn systeem uitgevoerd own Het is bedoeld om te worden geïntegreerd in een grotere uitdagingsstroom, bijvoorbeeld als een van de uitdagingstypen die worden ondersteund door [Spam blokkeren](./spam-blocker.md).
