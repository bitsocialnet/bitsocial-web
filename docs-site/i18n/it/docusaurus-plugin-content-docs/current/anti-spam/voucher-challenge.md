...
Poiché richiede la distribuzione manuale del codice, non è adattabile a grandi comunità aperte. Per questi scenari, considera [Blocco spam](./spam-blocker.md) o [EVM Contract Call Challenge](./evm-contract-call.md).
