...
Poiché il pacchetto è un puro generatore di immagini, non gestisce autonomamente la rete o la gestione delle sessioni. È destinato ad essere integrato in un flusso di sfide più ampio, ad esempio come uno dei tipi di sfide supportati da [Blocco spam](./spam-blocker.md).
