...
Se on rakennettu `plebbit-js`:n päälle, ja [5chan](/apps/5chan/) ja [Seedit] (/apps/seedit/) käyttävät sitä yhteisön luomiseen ja solmujen hallintaan.
...
| `subplebbit list`   | Listaa tässä solmussa isännöidyt yhteisöt             |
