...
Është ndërtuar në krye të `plebbit-js` dhe përdoret nga [5 kan](/apps/5chan/) dhe [Sedit](/apps/seedit/) për krijimin e komunitetit dhe menaxhimin e nyjeve.
...
**[Shkarkoni nga versionet e GitHub](https://github.com/bitsocialnet/bitsocial-cli/releases)**
