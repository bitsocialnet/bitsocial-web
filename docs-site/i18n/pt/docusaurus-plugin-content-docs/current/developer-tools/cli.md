...
Ele é construído sobre `plebbit-js` e é usado por [5chan](/apps/5chan/) e [Seeditar](/apps/seedit/) para criação de comunidades e gerenciamento de nós.
...
**[Baixe das versões do GitHub](https://github.com/bitsocialnet/bitsocial-cli/releases)**
