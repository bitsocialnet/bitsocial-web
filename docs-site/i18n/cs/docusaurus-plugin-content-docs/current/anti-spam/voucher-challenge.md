...
Protože vyžaduje ruční distribuci kódu, neškáluje se na velké otevřené komunity. Pro tyto scénáře zvažte místo toho [Blokátor spamu](./spam-blocker.md) nebo [Výzva na smluvní volání EVM](./evm-contract-call.md).
