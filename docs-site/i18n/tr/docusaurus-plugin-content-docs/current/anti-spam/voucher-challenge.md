...
Manuel kod dağıtımı gerektirdiğinden büyük açık topluluklara ölçeklenemez. Bu senaryolar için bunun yerine [Spam Engelleyici](./spam-blocker.md) veya [EVM Sözleşme Çağrısı Mücadelesi](./evm-contract-call.md) seçeneğini düşünün.
