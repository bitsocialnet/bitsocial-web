...
2. Selector d'idioma desat de `localStorage`
...
- [Índex de domini de l'anglès EF 2025](https://www.ef.edu/epi/) per al domini de l'anglès a nivell nacional
- [Cens de Singapur 2020](https://www.singstat.gov.sg/modules/infographics/census-2020) per a Singapur, on l'anglès era l'idioma familiar més parlat per al 48,3% dels residents de més de 5 anys

## Regions per defecte codificades en anglès

`AT`, `BE`, `CH`, `CZ`, `DE`, `DK`, `FI`, ZXQPLACEHOLDER, ZXQPLACEHOLDER, ZXQPLACEHOLDER, ZXQPLACEHOLDER, ZXQPLACEHOLDER,ZXQ `MY`, `NL`, `NO`, `PH`, `PL`, `PT`, `RO`OLDER, `RO`QOLDER, `RO`Q, `SG`

## Revisió de la configuració regional

| Localització | Regions revisades         | Últim senyal                                                                                              | Resultat                                                                      |
| ------------ | ------------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `ar`         | `AE`                      | UAE EF EPI 2025: 487, Moderat                                                                             | Idioma del navegador/dispositiu                                               |
...
| `de`         | `DE`, `AT`, `CH`          | Alemanya 615, Molt alt; Àustria 616, Molt alt; Suïssa 564, Alta                                           | Anglès en `DE`, `AT`, `CH`                                                    |
| `el`         | `GR`, `CY`                | Grècia 592, Alt; Xipre 537, Moderat                                                                       | Anglès en `GR`; Idioma del navegador/dispositiu en `CY`                       |
| `en`         | Locals de majoria anglesa | La configuració regional del navegador/dispositiu ja informa de `en-*` en el cas habitual                 | L'anglès continua sent per defecte                                            |
...
| `nl`         | `NL`, `BE`                | Països Baixos 624, Molt alt; Bèlgica 608, Molt alt                                                        | Anglès en `NL`, `BE`                                                          |
...
| `sv`         | `SE`, `FI`                | Suècia 609, Molt alt; Finlàndia 603, Molt alt                                                             | Anglès en `SE`, `FI`                                                          |
| `te`         | `IN`                      | Índia 484, Moderat                                                                                        | Idioma del navegador/dispositiu                                               |
| `th`         | `TH`                      | Tailàndia 402, molt baix                                                                                  | Idioma del navegador/dispositiu                                               |
| `tr`         | `TR`                      | Turquia 488, Moderat                                                                                      | Idioma del navegador/dispositiu                                               |
...
| `zh`         | `CN`, `HK`, `SG`          | Xina 464, Moderat; Hong Kong 538, Moderat; Cens de Singapur 2020: l'anglès més parlat a casa per un 48,3% | Anglès en `SG`; Idioma del navegador/dispositiu a `CN`, `HK` i altres regions |
