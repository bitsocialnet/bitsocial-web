...
Està construït sobre `plebbit-js` i és utilitzat per [5canal](/apps/5chan/) i [Seeedit](/apps/seedit/) per a la creació de comunitats i la gestió de nodes.
...
| `subplebbit stop`   | Deixar de servir una comunitat específica                              |
...
La comunitat ara està en directe a la xarxa Bitsocial i accessible des de qualsevol client compatible.
