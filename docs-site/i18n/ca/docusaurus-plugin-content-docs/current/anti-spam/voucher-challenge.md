...
Com que requereix una distribució manual de codi, no s'escala a grans comunitats obertes. Per a aquests escenaris, considereu [Bloquejador de correu brossa](./spam-blocker.md) o [EVM Contract Call Challenge](./evm-contract-call.md).
