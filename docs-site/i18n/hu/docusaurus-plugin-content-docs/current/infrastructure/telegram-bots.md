...
| Bot                | Állapot   | Leírás                                                                               |
| ------------------ | --------- | ------------------------------------------------------------------------------------ |
| **5csatorna feed** | Aktív     | Figyeli az összes 5chan könyvtárat, és továbbítja az új bejegyzéseket a Telegramnak. |
...
- Node.js
- Fonal
- Telegram bot token (hozzon létre egyet a [BotFather] segítségével (https://t.me/BotFather))
...
Hozzon létre egy `.env` fájlt a projekt gyökerében a bot tokennel:
