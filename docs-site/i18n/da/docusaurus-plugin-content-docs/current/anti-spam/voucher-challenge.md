...
Fordi det kræver manuel kodedistribution, skalerer det ikke til store åbne fællesskaber. For disse scenarier skal du overveje [Spam-blokering](./spam-blocker.md) eller [EVM Contract Call Challenge](./evm-contract-call.md) i stedet.
