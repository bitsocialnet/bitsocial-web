...
Den er bygget oven på `plebbit-js` og bruges af [5 chan](/apps/5chan/) og [Seedit](/apps/seedit/) til oprettelse af fællesskaber og nodeadministration.
...
| `subplebbit list`   | Vis fællesskaber hostet på denne node                         |
| `subplebbit start`  | Begynd at tjene et bestemt fællesskab                         |
| `subplebbit stop`   | Stop med at tjene et bestemt fællesskab                       |
...
Fællesskabet er nu live på Bitsocial-netværket og tilgængeligt fra enhver kompatibel klient.
