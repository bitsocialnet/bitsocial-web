...
Parce qu’il nécessite une distribution manuelle du code, il ne s’adapte pas aux grandes communautés ouvertes. Pour ces scénarios, envisagez plutôt [Bloqueur de spam](./spam-blocker.md) ou [Défi d'appel de contrat EVM](./evm-contract-call.md).
