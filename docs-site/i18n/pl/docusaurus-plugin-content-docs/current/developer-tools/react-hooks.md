...
Ta biblioteka jest głównym interfejsem używanym przez [5kan](/apps/5chan/) i inne aplikacje klienckie Bitsocial.
...
Haczyki są podzielone na kategorie funkcjonalne. Poniżej znajduje się podsumowanie najczęściej używanych haków w każdej kategorii. Aby zapoznać się z pełnymi podpisami, parametrami i typami zwrotów, zobacz [pełne informacje o interfejsie API w serwisie GitHub](https://github.com/bitsocialnet/bitsocial-react-hooks).
