...
This subproject contains the Bitsocial stats stack behind `https://stats.bitsocial.net/`.
...
- Public traffic reaches Grafana through shared dashboard URLs on `stats.bitsocial.net`, even though the Grafana app itself runs on the VPS.
