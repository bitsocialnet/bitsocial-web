...
- `/projects` already exists here as the public project catalog, and `/projects/:slug` handles app detail pages, but both should still be treated as a future separate subproject.
