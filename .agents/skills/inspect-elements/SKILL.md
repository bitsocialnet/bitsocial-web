...
description: Map a visible Bitsocial Web DOM node to its React source when file or component attribution is needed.
---
...
```bash
./scripts/pw-session.sh open inspect https://bitsocial.localhost/all
