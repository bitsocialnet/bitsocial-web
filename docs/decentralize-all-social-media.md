...
Bitsocial Chain, profile nodes, the Phase 3 Twitter/X alternative, and the service economy around
them.
...
- blogging clients
- crowdfunding apps
- creator video and a credible [YouTube alternative](https://github.com/bitsocialnet/wetube)
- creator communities
