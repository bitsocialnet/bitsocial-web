...
Bu kitaplık, [5chan](/apps/5chan/) ve diğer Bitsocial istemci uygulamaları tarafından kullanılan birincil arayüzdür.
...
Kancalar işlevsel kategoriler halinde düzenlenmiştir. Aşağıda her kategoride en sık kullanılan kancaların bir özeti bulunmaktadır. İmzaların, parametrelerin ve dönüş türlerinin tamamı için [GitHub'da tam API referansı](https://github.com/bitsocialnet/bitsocial-react-hooks).)'na bakın.
...
- **GitHub:** [GitHub'da tam API referansı](https://github.com/bitsocialnet/bitsocial-react-hooks)
