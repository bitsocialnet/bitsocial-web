...
Για κοινότητες που δεν βασίζονται στην ταυτότητα της αλυσίδας, πάρτε το ενδεχόμενο [Spam Blocker](./spam-blocker.md) ή [Voucher Challenge](./voucher-challenge.md).
