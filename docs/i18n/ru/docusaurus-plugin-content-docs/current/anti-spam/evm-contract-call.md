...
Для сообществ, которые не полагаются на сетевую идентификацию, рассмотрите вместо этого [Spam Blocker](./spam-blocker.md) или [Voucher Challenge](./voucher-challenge.md).
