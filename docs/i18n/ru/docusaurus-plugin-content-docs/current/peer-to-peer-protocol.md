...
description: Как Bitsocial использует адресацию с открытым ключом, одноранговую pubsub и узлы P2P браузера для предоставления бессерверных социальных сетей.
---
