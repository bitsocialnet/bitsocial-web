...
Ponieważ wymaga ręcznej dystrybucji kodu, nie można go skalować do dużych otwartych społeczności. W takich scenariuszach rozważ zamiast tego opcję [Spam Blocker](./spam-blocker.md) lub [EVM Contract Call Challenge](./evm-contract-call.md).
