...
Jest zbudowany na bazie `plebbit-js` i jest używany przez [5chan](/apps/5chan/) i [Seedit](/apps/seedit/) do tworzenia społeczności i zarządzania węzłami.
...
**[Pobierz z GitHub Wersje](https://github.com/bitsocialnet/bitsocial-cli/releases)**
