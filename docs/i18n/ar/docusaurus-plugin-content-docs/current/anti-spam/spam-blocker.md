...
تم نشر هذه الحزمة في الأصل ضمن النطاق `@plebbit`. تمت إعادة تسميته إلى `@bitsocial/spam-blocker-server` و`@bitsocial/spam-blocker-challenge`. قد تستمر الإشارات إلى الأسماء القديمة في الظهور في الوثائق أو قواعد التعليمات البرمجية القديمة.
:::
...
- **`@bitsocial/spam-blocker-server`** - خادم HTTP الذي يستضيف التقييم وواجهات برمجة التطبيقات (APIs).
...
| كارما                | الكارما المجتمعية المتراكمة تقلل من المخاطر.                                                                                                          |
...
| سرعة                 | المشاركات المتعاقبة السريعة من نفس المؤلف تزيد من المخاطر.                                                                                            |
