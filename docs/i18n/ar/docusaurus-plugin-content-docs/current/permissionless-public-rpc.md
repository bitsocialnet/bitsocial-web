...
كان اقتراح RPC العام الأصلي بمثابة إصدار GitHub مكتوبًا بمصطلحات عامة قديمة. تعيد هذه الصفحة كتابة هذه الفكرة بلغة Bitsocial وتضعها في إطار مقترح على مستوى المنتج بدلاً من جدار من تفاصيل التنفيذ.
...
على مستوى السلك، لا يزال بإمكان الطرح الأول الحفاظ على شكل النقل والحمولة الحالي لـ JSON-RPC حيث يكون ذلك مفيدًا للتوافق. بمعنى آخر: لم تعد المستندات بحاجة إلى التحدث مثل المستندات العامة القديمة، حتى لو احتفظت الفترة الانتقالية ببعض أسماء الطرق القديمة أو أشكال الطلب خلف الكواليس.
...
- الرؤية الأوسع هي إذن إداري صريح، وليس افتراضيًا
...
قد تستمر بعض التطبيقات المبكرة في الكشف عن أسماء الطرق القديمة داخليًا من أجل التوافق. يجب التعامل مع ذلك على أنه تفاصيل ترحيل، وليس كمفردات عامة دائمة لمستندات Bitsocial.
