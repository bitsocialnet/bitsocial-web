...
Azon közösségek esetében, amelyek nem támaszkodnak a láncon belüli identitásra, fontolja meg helyette a [Spam Blocker](./spam-blocker.md) vagy az [Voucher Challenge](./voucher-challenge.md) szolgáltatást.
