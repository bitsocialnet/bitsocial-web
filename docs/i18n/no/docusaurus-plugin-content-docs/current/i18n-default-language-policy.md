...
- [EF English Proficiency Index 2025](https://www.ef.edu/epi/) for engelskkunnskaper på landsnivå
- [Singapore Census 2020](https://www.singstat.gov.sg/modules/infographics/census-2020) for Singapore, der engelsk var det mest talte hjemmespråket for 48,3 % av innbyggerne i alderen 5+
...
| Språk | Regioner gjennomgått       | Siste signal                                                                                                   | Resultat                                                               |
| ----- | -------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
...
| `fil` | `PH`                       | Filippinene 569, High                                                                                          | engelsk på `PH`                                                        |
| `fr`  | `FR`, `BE`, `CH`           | Frankrike 539, Moderat; Belgia 608, Svært høy; Sveits 564, Høy                                                 | engelsk på `BE`, `CH`; nettleser-/enhetsspråk i `FR`                   |
...
| `ja`  | `JP`                       | Japan 446, veldig lav                                                                                          | Språk for nettleser/enhet                                              |
| `ko`  | `KR`                       | Sør-Korea 522, moderat                                                                                         | Språk for nettleser/enhet                                              |
| `mr`  | `IN`                       | India 484, Moderat                                                                                             | Språk for nettleser/enhet                                              |
| `nl`  | `NL`, `BE`                 | Nederland 624, Svært høy; Belgia 608, veldig høy                                                               | engelsk på `NL`, `BE`                                                  |
| `no`  | `NO`                       | Norge 613, Meget høy                                                                                           | engelsk på `NO`                                                        |
| `pl`  | `PL`                       | Polen 600, veldig høyt                                                                                         | engelsk på `PL`                                                        |
...
| `th`  | `TH`                       | Thailand 402, veldig lavt                                                                                      | Språk for nettleser/enhet                                              |
