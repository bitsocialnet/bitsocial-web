...
Bitsocial Network je název používaný v hlavním plánu pro sdílenou vrstvu appchain, která by seděla pod Bitsocial apps.
...
Pokud ekonomická vrstva stále závisí na hrstce centralizovaných kolejnic, pak aplikace zůstávají snadno pod tlakem, deplatformují se nebo finančně hladoví. Bitsocial Network je navrhovanou odpovědí na tuto druhou vrstvu závislosti.

## Vztah ke zbytku Bitsocial

Bitsocial Network je navržen jako sdílená infrastruktura pro aplikace Bitsocial, nikoli jako produkt, se kterým uživatelé komunikují přímo každý den.
