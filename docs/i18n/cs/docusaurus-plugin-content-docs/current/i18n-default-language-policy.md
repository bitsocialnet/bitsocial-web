...
2. Uložená volba výběru jazyka z `localStorage`
...
- [EF English Proficiency Index 2025](https://www.ef.edu/epi/) pro znalost angličtiny na úrovni země
- [Singapore Census 2020](https://www.singstat.gov.sg/modules/infographics/census-2020) pro Singapur, kde byla angličtina nejčastěji používaným domácím jazykem pro 48,3 % obyvatel ve věku 5+
...
| Národní prostředí | Zkontrolované regiony          | Nejnovější signál                                                                                                      | Výsledek                                                                      |
| ----------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
...
| `cs`              | `CZ`                           | Česko 582, vys                                                                                                         | angličtina v `CZ`                                                             |
| `da`              | `DK`                           | Dánsko 611, Velmi vysoká                                                                                               | angličtina v `DK`                                                             |
| `de`              | `DE`, `AT`, `CH`               | Německo 615, Velmi vysoká; Rakousko 616, Velmi vysoká; Švýcarsko 564, vys                                              | Angličtina v `DE`, `AT`, `CH`                                                 |
| `el`              | `GR`, `CY`                     | Řecko 592, vys.; Kypr 537, střední                                                                                     | angličtina v `GR`; jazyk prohlížeče/zařízení v `CY`                           |
| `en`              | Lokality s většinou angličtiny | Národní prostředí prohlížeče/zařízení již hlásí `en-*` v běžném případě                                                | Angličtina zůstává výchozí                                                    |
...
| `fil`             | `PH`                           | Filipíny 569, vys                                                                                                      | angličtina v `PH`                                                             |
| `fr`              | `FR`, `BE`, `CH`               | Francie 539, střední; Belgie 608, Velmi vysoká; Švýcarsko 564, vys                                                     | angličtina v `BE`, `CH`; jazyk prohlížeče/zařízení v `FR`                     |
| `he`              | `IL`                           | Izrael 524, střední                                                                                                    | Jazyk prohlížeče/zařízení                                                     |
| `hi`              | `IN`                           | Indie 484, střední                                                                                                     | Jazyk prohlížeče/zařízení                                                     |
| `hu`              | `HU`                           | Maďarsko 590, vys                                                                                                      | angličtina v `HU`                                                             |
| `id`              | `ID`                           | Indonésie 471, střední                                                                                                 | Jazyk prohlížeče/zařízení                                                     |
| `it`              | `IT`, `CH`                     | Itálie 513, střední; Švýcarsko 564, vys                                                                                | angličtina v `CH`; jazyk prohlížeče/zařízení v `IT`                           |
| `ja`              | `JP`                           | Japonsko 446, velmi nízké                                                                                              | Jazyk prohlížeče/zařízení                                                     |
| `ko`              | `KR`                           | Jižní Korea 522, střední                                                                                               | Jazyk prohlížeče/zařízení                                                     |
| `mr`              | `IN`                           | Indie 484, střední                                                                                                     | Jazyk prohlížeče/zařízení                                                     |
| `nl`              | `NL`, `BE`                     | Nizozemsko 624, Velmi vysoká; Belgium 608, Very high                                                                   | Angličtina v `NL`, `BE`                                                       |
