...
Debido a que el paquete es un generador de imágenes puro, no maneja la red ni la administración de sesiones por sí solo. Está pensado para integrarse en un flujo de desafíos más amplio, por ejemplo, como uno de los tipos de desafíos admitidos por [Spam Blocker](./spam-blocker.md).
