...
הצעת ה-RPC הציבורית המקורית חיה כבעיית GitHub שנכתבה בטרמינולוגיה ישנה של plebbit. דף זה משכתב את הרעיון בשפת Bitsocial וממסגר אותו כהצעה ברמת המוצר במקום חומה של פרטי יישום.
...
כיום, מודל ה-RPC הפשוט ביותר הוא בדרך כלל הכל או כלום: מפתח אישור אחד, תחום סמכות אחד, גישה מלאה. זה עובד עבור מפעיל יחיד אך לא עבור שירות רב-משתמש ציבורי.
...
קהילות שנוצרו באמצעות השירות מוקצות לרשומת בעלים. מעקב אחר הבעלות מתבצע במפורש כך שניתן להגדיר את שיטות הניהול למשתמש הנכון.
...
ברמת החוט, ההפצה הראשונה עדיין יכולה לשמר את צורת ההעברה והמטען הנוכחי של JSON-RPC במקום שבו זה שימושי לתאימות. במילים אחרות: המסמכים כבר לא צריכים לדבר כמו מסמכים ישנים, גם אם תקופת המעבר שומרת מאחורי הקלעים כמה שמות של שיטות מדור קודם או צורות בקשה.
...
כמה יישומים מוקדמים עדיין עשויים לחשוף שמות שיטות מדור קודם לצורך תאימות. יש להתייחס לזה כאל פרט הגירה, לא כאל אוצר המילים הציבורי הקבוע של Bitsocial docs.
