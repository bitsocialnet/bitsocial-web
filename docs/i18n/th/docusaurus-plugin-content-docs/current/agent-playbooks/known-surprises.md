...
- **สิ่งที่น่าประหลาดใจ:** URL ในเครื่องเริ่มต้นไม่ใช่พอร์ต Vite ปกติ repo คาดว่า `http://bitsocial.localhost:1355` จะผ่าน Portless ดังนั้นการตรวจสอบ `localhost:3000` หรือ `localhost:5173` อาจเข้าแอปผิดหรือไม่ได้อะไรเลย
- **ผลกระทบ:** การตรวจสอบเบราว์เซอร์อาจล้มเหลวหรือตรวจสอบเป้าหมายที่ไม่ถูกต้อง แม้ว่าเซิร์ฟเวอร์ dev จะทำงานได้ดีก็ตาม
- **การบรรเทาผลกระทบ:** ใช้ `http://bitsocial.localhost:1355` ก่อน หลีกเลี่ยงด้วย `PORTLESS=0 corepack yarn start` เมื่อคุณต้องการพอร์ต Vite โดยตรงเท่านั้น
- **สถานะ:** ยืนยันแล้ว
...
- **การบรรเทาผลกระทบ:** เก็บการเริ่มต้นระบบแบบไร้พอร์ตไว้ด้านหลัง `scripts/start-dev.mjs` ซึ่งขณะนี้ใช้เส้นทาง `*.bitsocial.localhost:1355` ที่มีขอบเขตสาขาอยู่นอกกรณีมาตรฐาน และถอยกลับไปยังเส้นทางที่มีขอบเขตสาขาเมื่อชื่อ `bitsocial.localhost` เปล่าถูกครอบครองแล้ว
- **สถานะ:** ยืนยันแล้ว
