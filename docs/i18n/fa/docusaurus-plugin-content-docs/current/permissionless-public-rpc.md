...
[Bitsocial Forge](https://bitsocialforge.com) می‌تواند یک سرویس RPC عمومی را اجرا کند که به بسیاری از کاربران اجازه می‌دهد تا جوامع Bitsocial خود را از راه دور مدیریت کنند، بدون اینکه اپراتور را به نگهبان آن جوامع تبدیل کند.
