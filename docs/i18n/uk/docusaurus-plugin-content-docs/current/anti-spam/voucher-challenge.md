...
Оскільки для цього потрібно розповсюджувати код вручну, він не масштабується для великих відкритих спільнот. Для таких сценаріїв замість цього розгляньте [Spam Blocker](./spam-blocker.md) або [EVM Contract Call Challenge](./evm-contract-call.md).
