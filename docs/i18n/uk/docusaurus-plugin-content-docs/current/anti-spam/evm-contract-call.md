...
Для спільнот, які не покладаються на ідентифікацію в ланцюжку, розгляньте натомість [Spam Blocker](./spam-blocker.md) або [Voucher Challenge](./voucher-challenge.md).
