...
Оскільки пакет є чистим генератором зображень, він не обробляє роботу в мережі чи керування сеансами самостійно. Його призначено для інтеграції в більший потік викликів, наприклад, як один із типів викликів, які підтримує [Spam Blocker](./spam-blocker.md).
