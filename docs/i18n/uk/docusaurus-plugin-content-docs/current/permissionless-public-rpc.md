...
[Bitsocial Forge](https://bitsocialforge.com) може запускати загальнодоступну службу RPC, яка дозволяє багатьом користувачам віддалено керувати власними спільнотами Bitsocial, не перетворюючи оператора на опікуна цих спільнот.
