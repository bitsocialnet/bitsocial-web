...
- **ఆశ్చర్యకరమైన విషయం:** డిఫాల్ట్ స్థానిక URL సాధారణ Vite పోర్ట్ కాదు. Repo పోర్ట్‌లెస్ ద్వారా `https://bitsocial.localhost`ని ఆశించింది, కాబట్టి `localhost:3000` లేదా `localhost:5173`ని తనిఖీ చేయడం వలన తప్పు యాప్ లేదా ఏమీ తగలదు.
- **ప్రభావం:** డెవ్ సర్వర్ ఆరోగ్యంగా ఉన్నప్పుడు కూడా బ్రౌజర్ తనిఖీలు విఫలమవుతాయి లేదా తప్పు లక్ష్యాన్ని ధృవీకరించవచ్చు.
- **తగ్గింపు:** ముందుగా `https://bitsocial.localhost`ని ఉపయోగించండి. మీకు ప్రత్యక్ష Vite పోర్ట్ అవసరమైనప్పుడు మాత్రమే `PORTLESS=0 corepack yarn start`తో బైపాస్ చేయండి.
