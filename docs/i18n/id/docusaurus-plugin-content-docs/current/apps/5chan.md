...
| Platform | Link                                   |
| -------- | -------------------------------------- |
| jaring   | [5chan.app](https://5chan.app)         |
...
Penetapan slot direktori (papan mana yang muncul di jalur mana) saat ini dikelola melalui permintaan tarik GitHub ke file `5chan-directories.json`. Ini adalah proses sementara — rilis mendatang akan mendukung pembuatan papan dalam aplikasi dan pemungutan suara berbasis pubsub untuk menangani penetapan direktori secara otomatis.
